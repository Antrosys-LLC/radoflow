...
const en = {
  nav: {
    canteenHistory: "Canteen history",
    salaries: "Salaries",
   ...
   */
  canteenHistory: {
    invoiceDaily: "Daily invoice",
    invoiceMonthly: "Monthly invoice",
    invoiceHint: "What the canteen is owed, priced by each day's menu",
    title: "Canteen history",
    subtitle: "Every meal served over the days you choose, and what it came to.",
    from: "From",
    to: "To",
    show: "Show",
    today: "Today",
    ...
    pricePerMeal: "Price per meal",
    setPrice: "Set the price",
    peopleFed: "People fed",
    byDay: "By day",
    byDayHint: "Meals served each day, and their cost",
    byMeal: "By meal",
    byPerson: "By person",
    byPersonHint: "Who ate, how often, and what it came to",
    person: "Person",
    department: "Department",
    meals: "Meals",
    amount: "Amount",
    noMeals: "No meals were served on these days.",
    noMealsHint: "Choose another range, or check the canteen terminal is set up.",
    unpricedNote:
      "{count} meals were served before a price was set — counted here at today's price of {price}.",
    unpricedNoPrice: "{count} meals have no price. Set the price of one meal in canteen settings.",
    history: "History",
    priceTitle: "Price of one meal",
    priceHint:
      "Every meal served from now on is recorded at this price. Meals already served keep the price they were served at.",
    priceLabel: "Rupees per meal",
    priceSaved: "Price saved.",
    priceInvalid: "Enter a price of zero or more.",
  },
  canteenMenu: {
    title: "Menu and price by day",
    hint: "What was cooked on each day, and what one meal of it costs. Every meal served that day is priced at this.",
    weeklyTitle: "Weekly menu",
    weeklyHint:
      "The dishes cooked on each weekday. A weekday with no dishes serves no meal. To change one date — no meal on Monday, a meal on Thursday — use that day's menu in canteen history.",
    dayTitle: "Menu for {date}",
    dayHint: "A dish added here replaces the weekly menu for this date only.",
    dish: "Dish",
    price: "Price (Rs)",
    add: "Add dish",
    remove: "Remove",
    perMeal: "One meal: {amount}",
    noDishes: "Nothing on the menu",
    fromSchedule: "From the weekly menu",
    ownMenu: "This day's own menu",
    closed: "Not a working day",
    changeThisDay: "Change this day only",
    pickDay: "Day",
    mealsThatDay: "{meals} meals × {price} = {amount}",
    weekdays: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    nameRequired: "Enter the dish.",
    priceInvalid: "Enter a price of zero or more.",
    chooseDay: "Choose a day.",
    noFactory: "No factory is set up.",
    added: "Dish added.",
    removed: "Removed.",
    nothingToCopy: "The weekly menu has nothing for this day.",
    copied: "This day now has its own menu — change any dish.",
    limitsTitle: "Meals per 24 hours",
    limitsHint:
      "Everybody eats once in any 24 hours. A contract firm can agree more for its people — set it for the whole department or for one person.",
    limitDepartments: "Contract departments",
    limitPeople: "Contract workers",
    limitDefault: "Default (1)",
    limitInvalid: "A limit is between 1 and 10 meals.",
    limitSaved: "Meal limit saved.",
    notMigrated:
      "Menus arrive with the latest database migration. Run it to start pricing meals by day.",
    noMealToday: "No meal this day",
    serveAgain: "Serve a meal again",
    moveTo: "Move this meal to",
    move: "Move",
    markedNoMeal: "This day serves no meal now.",
    mealBack: "This day serves its meal again.",
    moved: "Meal moved. The other day serves it, and this day serves none.",
    noMealMarked: "No meal — changed by the office",
    optionBadge: "Choice",
    optionCheckbox: "One of the choices — the canteen serves one of them all day",
    optionHint:
      "A meal is one of the choices, never both. Record which one was served on each day in canteen history.",
    whatServed: "What was served this day?",
    notChosen: "Not chosen yet — counted at {amount} until you pick.",
    notChosenBadge: "Choose what was served",
    needChoice: "{count} days still need what was served:",
    servedSaved: "Saved. This day's meals are priced at what was served.",
  },
  salaries: {
    ...
    salaryEarned: "Salary earned",
    overtimePay: "Overtime",
    allowancesLine: "Allowances",
    grossLine: "Gross",
    advancesLine: "Advances",
    suitLine: "Suit deduction",
    loanInstallment: "Loan installment",
    lateLine: "Late arrivals",
    otherLine: "Other deductions",
    netLine: "Net pay",
    loansBefore: "Loans taken before",
    loansLeft: "Left on loans",
    giveLoan: "Give a loan",
    loanGiven: "Loan added.",
    noLoansForPerson: "No loans.",
    title: "Salaries",
    subtitle:
      "What each person was owed, what they were actually handed, and what came off their pay.",
    ...
    paidTitle: "Salaries handed over",
    paidHint:
      "Enter what was actually given when it differs from the salary — the difference is worked out for you.",
    noRun: "No pay run for this month yet.",
    noRunHint: "Run payroll for the month first. The amounts to hand over come from it.",
    openPayroll: "Open payroll",
    notApproved: "This month's pay run has not been approved yet, so nobody can be marked as paid.",
    search: "Search a name or unique ID",
    person: "Person",
    ...
    over: "Over by {amount}",
    exact: "Paid in full",
    ledgerTitle: "Advances, suits and allowances",
    ledgerHint: "Taken off — or added to — this month's pay when payroll runs",
    kind: "Type",
    kinds: {
      advance: "Advance",
      advance_2: "Advance (second column)",
      suit: "Suit deduction",
      allowance: "Allowance",
    ...
    add: "Add",
    remove: "Remove",
    noLedger: "Nothing added for this month.",
    loansTitle: "Loans",
    loansHint:
      "Paid back from salary — a set amount each month, or spread over a number of months — until nothing is left.",
    principal: "Loan amount",
    repayBy: "Pay back",
    byInstallment: "Fixed amount",
    byMonths: "Over months",
    installment: "Each month (Rs)",
    months: "Number of months",
    firstMonth: "First deduction in",
    takenOn: "Taken on",
    plan: "{count} installments of {amount}, from {month}",
    planLast: "the last one {amount}",
    addLoan: "Add loan",
    noLoans: "No loans.",
    balance: "Left to pay",
    paidSoFar: "Paid back",
    progress: "{paid} of {count} installments",
    repayAmount: "Cash repaid",
    repay: "Record repayment",
    cancelLoan: "Cancel loan",
    active: "Being paid back",
    settled: "Paid off",
    cancelled: "Cancelled",
  },
  calendarScope: {
    scopedTitle: "Days for one department or one person",
    scopedHint:
      "A Sunday dyeing works and folding does not, or one man's day off in exchange. The most specific answer wins: the person, then the department, then the factory.",
    addScoped: "Add a day",
    scope: "For",
    ...
    choosePerson: "Choose a person",
    searchPerson: "Search a name or unique ID",
    noScoped: "No department or person days.",
    suggestTitle: "Upcoming holidays",
    suggestHint:
      "Claude looks up Pakistan's gazetted holidays and the Islamic days that follow the moon, and suggests which to mark.",
    suggest: "Suggest with Claude",
    suggesting: "Looking up holidays…",
    noSuggestions: "Nothing to suggest for the coming months.",
    addToCalendar: "Add as holiday",
    added: "On the calendar",
    announced: "Announced",
    expected: "Expected — depends on the moon",
    suggestFailed: "Could not get suggestions.",
    suggestCost: "This lookup cost {amount}.",
  },
  approvals: {
    ...
    undo: "Undo",
    restore: "Restore",
    undoLeft: "{minutes} min left to undo",
    recentlyDecided: "Decided in the last hour",
    recentlyDecidedHint:
      "Pressed the wrong one? A decision can be taken back for an hour — an approval is reversed exactly.",
    nothingRecent: "No decisions in the last hour.",
    ...
    kind: {
      ...
      calendar_override: "Calendar · department or person",
    },
  },
  /**
  ...
  dashboard: {
    shiftNow: "Shift now",
    shiftHint: "Who is rostered on the shift running right now, and how they came in",
    shiftWindow: "{start} to {end}, overtime to {overtime}",
    rostered: "Rostered",
    checkedInShift: "Checked in",
    lateShift: "Late",
    notInShift: "Not in",
    checkedOutShift: "Checked out",
    onOvertime: "On overtime",
    yourShift: "Your shift",
    noShift: "No shift set",
    flexibleShift: "No fixed time",
  ...
  payroll: {
    ...
    registerHint:
      "This run as the office's salary sheet — S Rate, days, hours, advances, loan and suit deductions and net pay, a department at a time.",
    periods: "Pay periods",
  ...
  rates: {
    ...
    searchPlaceholder: "Name, unique ID or CNIC",
    paidAs: "Paid as",
