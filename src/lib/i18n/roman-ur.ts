...
const roman: Dictionary = {
  ...
  clock: {
    showClock: "Ghari dikhayein",
    showCalendar: "Calendar dikhayein",
    factoryTime: "Factory ka waqt — Pakistan",
    previousMonth: "Pichhla mahina",
    nextMonth: "Agla mahina",
    month: "Mahina",
    year: "Saal",
    goToDate: "Kisi tareekh par jayein",
  },
  gate: {
    newEntry: "Indraj likhein",
    newEntryHint: "Jaise hi ho. Apna indraj ek ghante tak durust kar sakte hain.",
    register: "Register",
    nothingYet: "Is arse mein gate se kuch nahi guzra.",
    addEntry: "Register mein shamil karein",
    correctEntry: "Yeh indraj durust karein",
    removeEntry: "Yeh indraj hata dein",
    minutesLeft: "minute baqi",
    editedBy: "durust kiya",
    what: "Kya",
    direction: "Andar ya bahar",
    in: "Andar aana",
    out: "Bahar jana",
    subject: "Kaun ya kya",
    subjectPlaceholder: "Naam, number plate, ya saman kya hai",
    party: "Company ya manzil",
    purpose: "Maqsad",
    reference: "Hawala",
    referencePlaceholder: "Number plate, shanakhti card ya gate pass",
    quantity: "Miqdar",
    when: "Kab hua",
    remarks: "Tabsira",
    kind: {
