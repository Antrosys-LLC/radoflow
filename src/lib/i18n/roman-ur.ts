...
const roman: Dictionary = {
  nav: {
    canteenHistory: "Canteen ka record",
    salaries: "Tankhwahein",
    workspace: "Kaam",
  ...
  canteenHistory: {
    invoiceDaily: "Rozana bill",
    invoiceMonthly: "Mahana bill",
    invoiceHint: "Canteen ka bill, har din ke menu ke hisaab se",
    title: "Canteen ka record",
    subtitle: "Chune hue dinon mein diya gaya har khana, aur us ki kul laagat.",
    from: "Se",
    to: "Tak",
    show: "Dikhayein",
    today: "Aaj",
    thisMonth: "Yeh mahina",
    lastMonth: "Pichhla mahina",
    mealsServed: "Diye gaye khane",
    totalCost: "Kul laagat",
    pricePerMeal: "Fi khana qeemat",
    setPrice: "Qeemat muqarrar karein",
    peopleFed: "Khana khane wale",
    byDay: "Rozana",
    byDayHint: "Har din diye gaye khane, aur un ki laagat",
    byMeal: "Khane ke lihaz se",
    byPerson: "Fard ke lihaz se",
    byPersonHint: "Kis ne khaya, kitni baar, aur kitne ka",
    person: "Mulazim",
    department: "Shoba",
    meals: "Khane",
    amount: "Raqam",
    noMeals: "In dinon mein koi khana nahi diya gaya.",
    noMealsHint: "Koi aur arsa chunein, ya dekhein ke canteen ki machine lagi hui hai.",
    unpricedNote:
      "{count} khane qeemat muqarrar hone se pehle diye gaye — yahan aaj ki qeemat {price} par gine gaye hain.",
    unpricedNoPrice:
      "{count} khanon ki koi qeemat nahi. Canteen settings mein ek khane ki qeemat muqarrar karein.",
    history: "Record",
    priceTitle: "Ek khane ki qeemat",
    priceHint:
      "Ab se diya jane wala har khana isi qeemat par darj hoga. Pehle diye gaye khane apni purani qeemat par rahenge.",
    priceLabel: "Rupay fi khana",
    priceSaved: "Qeemat mehfooz ho gayi.",
    priceInvalid: "Sifr ya us se zyada qeemat likhein.",
  },
  canteenMenu: {
    title: "Rozana menu aur qeemat",
    hint: "Har din kya paka, aur ek khane ki qeemat kya hai. Us din ka har khana isi qeemat par gina jata hai.",
    weeklyTitle: "Hafta-waar menu",
    weeklyHint:
      "Har din pakne wale khane. Jis din koi khana na ho us din khana nahi milta. Kisi ek tareekh ko badalne ke liye — peer ko khana nahi, jumeraat ko khana — canteen history mein us din ka menu istemal karein.",
    dayTitle: "{date} ka menu",
    dayHint:
      "Yahan shamil kiya gaya khana sirf is tareekh ke liye hafta-waar menu ki jagah leta hai.",
    dish: "Khana",
    price: "Qeemat (Rs)",
    add: "Khana shamil karein",
    remove: "Hatayein",
    perMeal: "Ek khana: {amount}",
    noDishes: "Menu mein kuch nahi",
    fromSchedule: "Hafta-waar menu se",
    ownMenu: "Is din ka apna menu",
    closed: "Kaam ka din nahi",
    changeThisDay: "Sirf yeh din badlein",
    pickDay: "Din",
    mealsThatDay: "{meals} khane × {price} = {amount}",
    weekdays: ["Itwaar", "Peer", "Mangal", "Budh", "Jumeraat", "Jumma", "Hafta"],
    nameRequired: "Khane ka naam likhein.",
    priceInvalid: "Sifar ya us se zyada qeemat likhein.",
    chooseDay: "Din muntakhib karein.",
    noFactory: "Koi factory muqarrar nahi.",
    added: "Khana shamil ho gaya.",
    removed: "Hata diya.",
    nothingToCopy: "Hafta-waar menu mein is din ke liye kuch nahi.",
    copied: "Ab is din ka apna menu hai — koi bhi khana badlein.",
    limitsTitle: "24 ghanton mein khane",
    limitsHint:
      "Har shakhs 24 ghanton mein ek baar khata hai. Theekedar apne logon ke liye zyada tay kar sakta hai — poore shobay ya ek shakhs ke liye.",
    limitDepartments: "Theekay ke shobay",
    limitPeople: "Theekay ke mazdoor",
    limitDefault: "Mamool (1)",
    limitInvalid: "Had 1 se 10 khanon tak hai.",
    limitSaved: "Khane ki had mehfooz ho gayi.",
    notMigrated:
      "Menu taaza database migration ke saath aata hai. Din ke hisaab se qeemat ke liye ise chalayein.",
    noMealToday: "Is din khana nahi",
    serveAgain: "Dobara khana dein",
    moveTo: "Yeh khana muntaqil karein",
    move: "Muntaqil karein",
    markedNoMeal: "Ab is din khana nahi milega.",
    mealBack: "Is din dobara khana milega.",
    moved: "Khana muntaqil ho gaya. Doosre din milega, is din nahi.",
    noMealMarked: "Khana nahi — daftar ne badla",
    optionBadge: "Intikhab",
    optionCheckbox: "Intikhab mein se ek — canteen saara din in mein se ek deti hai",
    optionHint:
      "Ek khana intikhab mein se ek hai, dono nahi. Canteen history mein har din likhein ke kya diya gaya.",
    whatServed: "Is din kya diya gaya?",
    notChosen: "Abhi muntakhib nahi — intikhab tak {amount} par gina ja raha hai.",
    notChosenBadge: "Muntakhib karein kya diya gaya",
    needChoice: "{count} dinon ke liye abhi likhna hai ke kya diya gaya:",
    servedSaved: "Mehfooz ho gaya. Is din ke khane isi qeemat par gine jayenge.",
  },
  salaries: {
    peopleCount: "{count} log",
    entriesCount: "{count} indraaj",
    loansCount: "{count} qarz",
    breakdown: "Mukammal tafseel",
    hideBreakdown: "Tafseel chhupayein",
    daysWorked: "Kaam ke din",
    salaryEarned: "Kamayi gayi tankhwah",
    overtimePay: "Overtime",
    allowancesLine: "Allowance",
    grossLine: "Kul tankhwah",
    advancesLine: "Advance",
    suitLine: "Suit katauti",
    loanInstallment: "Qarz ki qist",
    lateLine: "Der se aamad",
    otherLine: "Deegar katautiyan",
    netLine: "Khalis tankhwah",
    loansBefore: "Pehle liye gaye qarz",
    loansLeft: "Qarz baqi",
    giveLoan: "Qarz dein",
    loanGiven: "Qarz shamil ho gaya.",
    noLoansForPerson: "Koi qarz nahi.",
    title: "Tankhwahein",
    subtitle: "Har fard ki banti tankhwah, use asal mein kitni di gayi, aur tankhwah se kya kata.",
    previousMonth: "Pichhla mahina",
    nextMonth: "Agla mahina",
    netToPay: "Ada karni hai",
    handedOver: "Di gayi",
    difference: "Farq",
    advancesThisMonth: "Is mahine ke advance",
    loansOutstanding: "Baqi qarz",
    paidTitle: "Di gayi tankhwahein",
    paidHint:
      "Agar tankhwah se mukhtalif raqam di gayi ho to woh likhein — farq khud hisaab ho jaye ga.",
    noRun: "Is mahine ka tankhwah hisaab abhi nahi bana.",
    noRunHint: "Pehle is mahine ka payroll chalayein. Dene wali raqam usi se aati hai.",
    openPayroll: "Payroll kholein",
    notApproved:
      "Is mahine ka hisaab abhi manzoor nahi hua, is liye kisi ko ada shuda nahi likha ja sakta.",
    search: "Naam ya unique ID talash karein",
    person: "Mulazim",
    choosePerson: "Mulazim chunein",
    salary: "Tankhwah",
    given: "Di gayi",
    note: "Note",
    markPaid: "Ada shuda likhein",
    undoPaid: "Wapas",
    short: "{amount} kam",
    over: "{amount} zyada",
    exact: "Poori ada",
    ledgerTitle: "Advance, suit aur allowance",
    ledgerHint: "Payroll chalne par is mahine ki tankhwah se katte — ya us mein judte — hain",
    kind: "Qisam",
    kinds: {
      advance: "Advance",
      advance_2: "Advance (doosra column)",
      suit: "Suit katauti",
      allowance: "Allowance",
      deduction: "Deegar katauti",
    },
    amount: "Raqam",
    label: "Unwaan",
    givenOn: "Dene ki tareekh",
    add: "Shamil karein",
    remove: "Hatayein",
    noLedger: "Is mahine ke liye kuch shamil nahi kiya gaya.",
    loansTitle: "Qarz",
    loansHint:
      "Tankhwah se wapas hota hai — har mahine ek muqarrara raqam, ya chand mahinon mein taqseem — jab tak kuch baqi na rahe.",
    principal: "Qarz ki raqam",
    repayBy: "Wapsi",
    byInstallment: "Muqarrara raqam",
    byMonths: "Mahinon mein",
    installment: "Har mahine (Rs)",
    months: "Mahinon ki tadaad",
    firstMonth: "Pehli katauti",
    takenOn: "Lene ki tareekh",
    plan: "{amount} ki {count} qistein, {month} se",
    planLast: "aakhri qist {amount}",
    addLoan: "Qarz shamil karein",
    noLoans: "Koi qarz nahi.",
    balance: "Baqi",
    paidSoFar: "Wapas hua",
    progress: "{count} mein se {paid} qistein",
    repayAmount: "Naqd wapsi",
    repay: "Wapsi darj karein",
    cancelLoan: "Qarz mansookh karein",
    active: "Wapas ho raha hai",
    settled: "Ada ho gaya",
    cancelled: "Mansookh",
  },
  calendarScope: {
    scopedTitle: "Kisi shobe ya fard ke din",
    scopedHint:
      "Itwar ko dyeing kaam kare aur folding nahi, ya kisi ek ki badle ki chhutti. Sab se makhsoos jawab lagu hota hai: fard, phir shoba, phir factory.",
    addScoped: "Din shamil karein",
    scope: "Kis ke liye",
    department: "Ek shoba",
    person: "Ek fard",
    chooseDepartment: "Shoba chunein",
    choosePerson: "Mulazim chunein",
    searchPerson: "Naam ya unique ID talash karein",
    noScoped: "Kisi shobe ya fard ka koi din nahi.",
    suggestTitle: "Aane wali chhuttiyan",
    suggestHint:
      "Claude Pakistan ki sarkari chhuttiyan aur chand par munhasir Islami din talash kar ke batata hai ke kaun se lagane hain.",
    suggest: "Claude se poochein",
    suggesting: "Chhuttiyan talash ho rahi hain…",
    noSuggestions: "Aane wale mahinon ke liye koi tajweez nahi.",
    addToCalendar: "Chhutti lagayein",
    added: "Calendar par hai",
    announced: "Elaan shuda",
    expected: "Mutawaqqa — chand par munhasir",
    suggestFailed: "Tajaweez nahi mil sakein.",
    suggestCost: "Is talash par {amount} lage.",
  },
  approvals: {
    ...
    withdraw: "Wapas lein",
    undo: "Faisla wapas karein",
    restore: "Bahaal karein",
    undoLeft: "Wapsi ke liye {minutes} minute baqi",
    recentlyDecided: "Pichhle ek ghante ke faisle",
    recentlyDecidedHint:
      "Ghalat button dab gaya? Faisla ek ghante tak wapas ho sakta hai — manzoori bilkul pehle jaisi ho jati hai.",
    nothingRecent: "Pichhle ek ghante mein koi faisla nahi hua.",
    ...
    kind: {
      ...
      calendar_override: "Calendar · shoba ya fard",
    },
  },
  clock: {
  ...
  dashboard: {
    shiftNow: "Maujooda shift",
    shiftHint: "Is waqt chalne wali shift par kaun hai, aur woh kaise aaye",
    shiftWindow: "{start} se {end}, overtime {overtime} tak",
    rostered: "Shift par",
    checkedInShift: "Haazir",
    lateShift: "Der se",
    notInShift: "Nahi aaye",
    checkedOutShift: "Chale gaye",
    onOvertime: "Overtime par",
    yourShift: "Aap ki shift",
    noShift: "Shift muqarrar nahi",
    flexibleShift: "Koi muqarrara waqt nahi",
  ...
  ask: {
    effortTitle: "Soch ki gehrai",
    faster: "Tez",
    smarter: "Zyada samajhdar",
  ...
  payroll: {
    payslipPdf: "Tankhwah parchi PDF",
    register: "Tankhwah register",
    registerHint:
      "Yeh hisaab daftar ki tankhwah sheet ki soorat mein — S Rate, din, ghante, advance, qarz aur suit katauti aur khalis tankhwah, ek ek shoba kar ke.",
  ...
  users: {
    ...
    employeeCode: "Unique ID / K50 number",
