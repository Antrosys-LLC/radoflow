...
const ur: Dictionary = {
  nav: {
    canteenHistory: "کینٹین کا ریکارڈ",
    salaries: "تنخواہیں",
    workspace: "کام",
  ...
  errors: {
    ...
    schemaTitle: "ڈیٹابیس میں ایک حالیہ اپ ڈیٹ باقی ہے",
    schemaBody:
      "کچھ خراب نہیں ہوا اور نہ کچھ ضائع ہوا۔ ڈیٹابیس کی ایک اپ ڈیٹ ابھی لاگو نہیں ہوئی — اینٹروسس سے supabase/APPLY-PENDING.sql چلوائیں، یہ سکرین چلنے لگے گی۔",
  ...
  canteenHistory: {
    invoiceDaily: "روزانہ بل",
    invoiceMonthly: "ماہانہ بل",
    invoiceHint: "کینٹین کا بل، ہر دن کے مینو کے حساب سے",
    title: "کینٹین کا ریکارڈ",
    subtitle: "چنے ہوئے دنوں میں دیا گیا ہر کھانا، اور اس کی کل لاگت۔",
    from: "سے",
    to: "تک",
    show: "دکھائیں",
    today: "آج",
    ...
    mealsServed: "دیے گئے کھانے",
    totalCost: "کل لاگت",
    pricePerMeal: "فی کھانا قیمت",
    setPrice: "قیمت مقرر کریں",
    peopleFed: "کھانا کھانے والے",
    byDay: "روزانہ",
    byDayHint: "ہر دن دیے گئے کھانے، اور ان کی لاگت",
    byMeal: "کھانے کے لحاظ سے",
    byPerson: "فرد کے لحاظ سے",
    byPersonHint: "کس نے کھایا، کتنی بار، اور کتنے کا",
    person: "ملازم",
    department: "شعبہ",
    meals: "کھانے",
    amount: "رقم",
    noMeals: "ان دنوں میں کوئی کھانا نہیں دیا گیا۔",
    noMealsHint: "کوئی اور عرصہ چنیں، یا دیکھیں کہ کینٹین کی مشین لگی ہوئی ہے۔",
    unpricedNote:
      "{count} کھانے قیمت مقرر ہونے سے پہلے دیے گئے — یہاں آج کی قیمت {price} پر گنے گئے ہیں۔",
    unpricedNoPrice:
      "{count} کھانوں کی کوئی قیمت نہیں۔ کینٹین کی ترتیبات میں ایک کھانے کی قیمت مقرر کریں۔",
    history: "ریکارڈ",
    priceTitle: "ایک کھانے کی قیمت",
    priceHint:
      "اب سے دیا جانے والا ہر کھانا اسی قیمت پر درج ہوگا۔ پہلے دیے گئے کھانے اپنی پرانی قیمت پر رہیں گے۔",
    priceLabel: "روپے فی کھانا",
    priceSaved: "قیمت محفوظ ہو گئی۔",
    priceInvalid: "صفر یا اس سے زیادہ قیمت لکھیں۔",
  },
  canteenMenu: {
    title: "روزانہ مینو اور قیمت",
    hint: "ہر دن کیا پکا، اور ایک کھانے کی قیمت کیا ہے۔ اس دن کا ہر کھانا اسی قیمت پر گنا جاتا ہے۔",
    weeklyTitle: "ہفتہ وار مینو",
    weeklyHint:
      "ہر دن پکنے والے کھانے۔ جس دن کوئی کھانا نہ ہو اس دن کھانا نہیں ملتا۔ کسی ایک تاریخ کو بدلنے کے لیے — پیر کو کھانا نہیں، جمعرات کو کھانا — کینٹین ہسٹری میں اس دن کا مینو استعمال کریں۔",
    dayTitle: "{date} کا مینو",
    dayHint: "یہاں شامل کیا گیا کھانا صرف اس تاریخ کے لیے ہفتہ وار مینو کی جگہ لیتا ہے۔",
    dish: "کھانا",
    price: "قیمت (روپے)",
    add: "کھانا شامل کریں",
    remove: "ہٹائیں",
    perMeal: "ایک کھانا: {amount}",
    noDishes: "مینو میں کچھ نہیں",
    fromSchedule: "ہفتہ وار مینو سے",
    ownMenu: "اس دن کا اپنا مینو",
    closed: "کام کا دن نہیں",
    changeThisDay: "صرف یہ دن بدلیں",
    pickDay: "دن",
    mealsThatDay: "{meals} کھانے × {price} = {amount}",
    weekdays: ["اتوار", "پیر", "منگل", "بدھ", "جمعرات", "جمعہ", "ہفتہ"],
    nameRequired: "کھانے کا نام لکھیں۔",
    priceInvalid: "صفر یا اس سے زیادہ قیمت لکھیں۔",
    chooseDay: "دن منتخب کریں۔",
    noFactory: "کوئی فیکٹری مقرر نہیں۔",
    added: "کھانا شامل ہو گیا۔",
    removed: "ہٹا دیا۔",
    nothingToCopy: "ہفتہ وار مینو میں اس دن کے لیے کچھ نہیں۔",
    copied: "اب اس دن کا اپنا مینو ہے — کوئی بھی کھانا بدلیں۔",
    limitsTitle: "24 گھنٹوں میں کھانے",
    limitsHint:
      "ہر شخص 24 گھنٹوں میں ایک بار کھاتا ہے۔ ٹھیکیدار اپنے لوگوں کے لیے زیادہ طے کر سکتا ہے — پورے شعبے یا ایک شخص کے لیے۔",
    limitDepartments: "ٹھیکے کے شعبے",
    limitPeople: "ٹھیکے کے مزدور",
    limitDefault: "معمول (1)",
    limitInvalid: "حد 1 سے 10 کھانوں تک ہے۔",
    limitSaved: "کھانے کی حد محفوظ ہو گئی۔",
    notMigrated:
      "مینو تازہ ڈیٹا بیس مائیگریشن کے ساتھ آتا ہے۔ دن کے حساب سے قیمت کے لیے اسے چلائیں۔",
    noMealToday: "اس دن کھانا نہیں",
    serveAgain: "دوبارہ کھانا دیں",
    moveTo: "یہ کھانا منتقل کریں",
    move: "منتقل کریں",
    markedNoMeal: "اب اس دن کھانا نہیں ملے گا۔",
    mealBack: "اس دن دوبارہ کھانا ملے گا۔",
    moved: "کھانا منتقل ہو گیا۔ دوسرے دن ملے گا، اس دن نہیں۔",
    noMealMarked: "کھانا نہیں — دفتر نے بدلا",
    optionBadge: "انتخاب",
    optionCheckbox: "انتخاب میں سے ایک — کینٹین سارا دن ان میں سے ایک دیتی ہے",
    optionHint:
      "ایک کھانا انتخاب میں سے ایک ہے، دونوں نہیں۔ کینٹین ہسٹری میں ہر دن لکھیں کہ کیا دیا گیا۔",
    whatServed: "اس دن کیا دیا گیا؟",
    notChosen: "ابھی منتخب نہیں — انتخاب تک {amount} پر گنا جا رہا ہے۔",
    notChosenBadge: "منتخب کریں کیا دیا گیا",
    needChoice: "{count} دنوں کے لیے ابھی لکھنا ہے کہ کیا دیا گیا:",
    servedSaved: "محفوظ ہو گیا۔ اس دن کے کھانے اسی قیمت پر گنے جائیں گے۔",
  },
  salaries: {
    peopleCount: "{count} افراد",
    entriesCount: "{count} اندراجات",
    loansCount: "{count} قرضے",
    breakdown: "مکمل تفصیل",
    hideBreakdown: "تفصیل چھپائیں",
    daysWorked: "کام کے دن",
    salaryEarned: "کمائی گئی تنخواہ",
    overtimePay: "اوور ٹائم",
    allowancesLine: "الاؤنس",
    grossLine: "کل تنخواہ",
    advancesLine: "ایڈوانس",
    suitLine: "سوٹ کٹوتی",
    loanInstallment: "قرض کی قسط",
    lateLine: "دیر سے آمد",
    otherLine: "دیگر کٹوتیاں",
    netLine: "خالص تنخواہ",
    loansBefore: "پہلے لیے گئے قرضے",
    loansLeft: "قرض باقی",
    giveLoan: "قرض دیں",
    loanGiven: "قرض شامل ہو گیا۔",
    noLoansForPerson: "کوئی قرض نہیں۔",
    title: "تنخواہیں",
    subtitle: "ہر فرد کی بنتی تنخواہ، اسے اصل میں کتنی دی گئی، اور تنخواہ سے کیا کٹا۔",
    previousMonth: "پچھلا مہینہ",
    nextMonth: "اگلا مہینہ",
    netToPay: "ادا کرنی ہے",
    handedOver: "دی گئی",
    difference: "فرق",
    advancesThisMonth: "اس مہینے کے ایڈوانس",
    loansOutstanding: "باقی قرض",
    paidTitle: "دی گئی تنخواہیں",
    paidHint: "اگر تنخواہ سے مختلف رقم دی گئی ہو تو وہ لکھیں — فرق خود حساب ہو جائے گا۔",
    noRun: "اس مہینے کا تنخواہ حساب ابھی نہیں بنا۔",
    noRunHint: "پہلے اس مہینے کا پے رول چلائیں۔ دینے والی رقم اسی سے آتی ہے۔",
    openPayroll: "پے رول کھولیں",
    notApproved: "اس مہینے کا حساب ابھی منظور نہیں ہوا، اس لیے کسی کو ادا شدہ نہیں لکھا جا سکتا۔",
    search: "نام یا یونیک آئی ڈی تلاش کریں",
    person: "ملازم",
    choosePerson: "ملازم چنیں",
    salary: "تنخواہ",
    given: "دی گئی",
    note: "نوٹ",
    ...
    over: "{amount} زیادہ",
    exact: "پوری ادا",
    ledgerTitle: "ایڈوانس، سوٹ اور الاؤنس",
    ledgerHint: "پے رول چلنے پر اس مہینے کی تنخواہ سے کٹتے — یا اس میں جڑتے — ہیں",
    kind: "قسم",
    kinds: {
      advance: "ایڈوانس",
      advance_2: "ایڈوانس (دوسرا کالم)",
      suit: "سوٹ کٹوتی",
      allowance: "الاؤنس",
      deduction: "دیگر کٹوتی",
    },
    amount: "رقم",
    label: "عنوان",
    givenOn: "دینے کی تاریخ",
    add: "شامل کریں",
    remove: "ہٹائیں",
    noLedger: "اس مہینے کے لیے کچھ شامل نہیں کیا گیا۔",
    loansTitle: "قرض",
    loansHint:
      "تنخواہ سے واپس ہوتا ہے — ہر مہینے ایک مقررہ رقم، یا چند مہینوں میں تقسیم — جب تک کچھ باقی نہ رہے۔",
    principal: "قرض کی رقم",
    repayBy: "واپسی",
    byInstallment: "مقررہ رقم",
    byMonths: "مہینوں میں",
    installment: "ہر مہینے (روپے)",
    months: "مہینوں کی تعداد",
    firstMonth: "پہلی کٹوتی",
    takenOn: "لینے کی تاریخ",
    plan: "{amount} کی {count} قسطیں، {month} سے",
    planLast: "آخری قسط {amount}",
    addLoan: "قرض شامل کریں",
    noLoans: "کوئی قرض نہیں۔",
    balance: "باقی",
    paidSoFar: "واپس ہوا",
    progress: "{count} میں سے {paid} قسطیں",
    repayAmount: "نقد واپسی",
    repay: "واپسی درج کریں",
    cancelLoan: "قرض منسوخ کریں",
    active: "واپس ہو رہا ہے",
    settled: "ادا ہو گیا",
    cancelled: "منسوخ",
  },
  calendarScope: {
    scopedTitle: "کسی شعبے یا فرد کے دن",
    scopedHint:
      "اتوار کو ڈائنگ کام کرے اور فولڈنگ نہیں، یا کسی ایک کی بدلے کی چھٹی۔ سب سے مخصوص جواب لاگو ہوتا ہے: فرد، پھر شعبہ، پھر فیکٹری۔",
    addScoped: "دن شامل کریں",
    scope: "کس کے لیے",
    department: "ایک شعبہ",
    person: "ایک فرد",
    chooseDepartment: "شعبہ چنیں",
    choosePerson: "ملازم چنیں",
    searchPerson: "نام یا یونیک آئی ڈی تلاش کریں",
    noScoped: "کسی شعبے یا فرد کا کوئی دن نہیں۔",
    suggestTitle: "آنے والی چھٹیاں",
    suggestHint:
      "Claude پاکستان کی سرکاری چھٹیاں اور چاند پر منحصر اسلامی دن تلاش کر کے بتاتا ہے کہ کون سے لگانے ہیں۔",
    suggest: "Claude سے پوچھیں",
    suggesting: "چھٹیاں تلاش ہو رہی ہیں…",
    noSuggestions: "آنے والے مہینوں کے لیے کوئی تجویز نہیں۔",
    addToCalendar: "چھٹی لگائیں",
    added: "کیلنڈر پر ہے",
    announced: "اعلان شدہ",
    expected: "متوقع — چاند پر منحصر",
    suggestFailed: "تجاویز نہیں مل سکیں۔",
    suggestCost: "اس تلاش پر {amount} لگے۔",
  },
  approvals: {
    waiting: "آپ کے منتظر",
    ...
    reject: "مسترد کریں",
    withdraw: "واپس لیں",
    undo: "فیصلہ واپس کریں",
    restore: "بحال کریں",
    undoLeft: "واپسی کے لیے {minutes} منٹ باقی",
    recentlyDecided: "پچھلے ایک گھنٹے کے فیصلے",
    recentlyDecidedHint:
      "غلط بٹن دب گیا؟ فیصلہ ایک گھنٹے تک واپس ہو سکتا ہے — منظوری بالکل پہلے جیسی ہو جاتی ہے۔",
    nothingRecent: "پچھلے ایک گھنٹے میں کوئی فیصلہ نہیں ہوا۔",
    ...
    kind: {
      ...
      calendar_override: "کیلنڈر · شعبہ یا فرد",
    },
  },
  clock: {
  ...
  gate: {
    newEntry: "اندراج لکھیں",
    newEntryHint: "جیسے ہی ہو۔ اپنا اندراج ایک گھنٹے تک درست کر سکتے ہیں۔",
    register: "رجسٹر",
    nothingYet: "اس عرصے میں گیٹ سے کچھ نہیں گزرا۔",
    addEntry: "رجسٹر میں شامل کریں",
    correctEntry: "یہ اندراج درست کریں",
    removeEntry: "یہ اندراج ہٹا دیں",
    minutesLeft: "منٹ باقی",
    editedBy: "درست کیا",
    what: "کیا",
    direction: "اندر یا باہر",
    in: "اندر آنا",
    out: "باہر جانا",
    subject: "کون یا کیا",
    subjectPlaceholder: "نام، نمبر پلیٹ، یا سامان کیا ہے",
    party: "کمپنی یا منزل",
    purpose: "مقصد",
    reference: "حوالہ",
    referencePlaceholder: "نمبر پلیٹ، شناختی کارڈ یا گیٹ پاس",
    quantity: "مقدار",
    when: "کب ہوا",
    remarks: "تبصرہ",
    kind: {
  ...
  dashboard: {
    shiftNow: "موجودہ شفٹ",
    shiftHint: "اس وقت چلنے والی شفٹ پر کون ہے، اور وہ کیسے آئے",
    shiftWindow: "{start} سے {end}، اوور ٹائم {overtime} تک",
    rostered: "شفٹ پر",
    checkedInShift: "حاضر",
    lateShift: "دیر سے",
    notInShift: "نہیں آئے",
    checkedOutShift: "چلے گئے",
    onOvertime: "اوور ٹائم پر",
    yourShift: "آپ کی شفٹ",
    noShift: "شفٹ مقرر نہیں",
    flexibleShift: "کوئی مقررہ وقت نہیں",
  ...
  devices: {
    ...
    mergeRosters: "سب مشینوں کا عملہ ایک جیسا کریں",
    mergeRunning: "مشینوں کا عملہ ملایا جا رہا ہے…",
    mergeQueued: "{count} ہدایات قطار میں۔ ہر مشین جو اس کے پاس نہیں تھا وہ اگلی بار خود لے لے گی۔",
    mergeAlreadyIdentical: "سب مشینوں پر عملہ پہلے ہی ایک جیسا ہے۔ کچھ بھیجنے کی ضرورت نہیں۔",
  ...
  ask: {
    effortTitle: "سوچ کی گہرائی",
    faster: "تیز",
    smarter: "زیادہ سمجھدار",
  ...
  payroll: {
    payslipPdf: "تنخواہ پرچی PDF",
    register: "تنخواہ رجسٹر",
    registerHint:
      "یہ حساب دفتر کی تنخواہ شیٹ کی صورت میں — ایس ریٹ، دن، گھنٹے، ایڈوانس، قرض اور سوٹ کٹوتی اور خالص تنخواہ، ایک ایک شعبہ کر کے۔",
  ...
  users: {
    ...
    employeeCode: "یونیک آئی ڈی / K50 نمبر",
