...
const ur: Dictionary = {
  ...
  approvals: {
    waiting: "آپ کے منتظر",
    waitingHint: "جن تبدیلیوں کی منظوری آپ سے مانگی گئی ہے۔ آپ کی منظوری تک کچھ لاگو نہیں ہوتا۔",
    cannotDecide: "یہ فیصلے کرنے والوں میں آپ شامل نہیں۔",
    nothingWaiting: "کوئی فیصلہ زیرِ التوا نہیں۔",
    mine: "میں نے کیا مانگا",
    mineHint: "آپ کی اپنی درخواستیں، اور ان کا نتیجہ",
    noneOfMine: "آپ نے ابھی کچھ نہیں مانگا۔",
    approve: "منظور کریں",
    reject: "مسترد کریں",
    withdraw: "واپس لیں",
    note: "فیصلے کے ساتھ نوٹ",
    notePlaceholder: "وجہ، اگر لکھنی ہو",
    sendTo: "منظوری کے لیے بھیجیں",
    sendToHint: "یہ تبدیلی ان کی منظوری تک روکی رہے گی۔",
    pickApprover: "فیصلہ کرنے والا چنیں",
    needsApproval: "منظوری درکار",
    status: {
      pending: "زیرِ التوا",
      approved: "منظور",
      rejected: "مسترد",
    ...
    kind: {
      attendance_correction: "حاضری",
      calendar_day: "کیلنڈر",
      work_week: "کام کا ہفتہ",
      pay_change: "اجرت",
      contract_amount: "ٹھیکہ",
    },
  },
  clock: {
    showClock: "گھڑی دکھائیں",
    showCalendar: "کیلنڈر دکھائیں",
    factoryTime: "فیکٹری کا وقت — پاکستان",
    previousMonth: "پچھلا مہینہ",
    nextMonth: "اگلا مہینہ",
    month: "مہینہ",
    year: "سال",
    goToDate: "کسی تاریخ پر جائیں",
  },
  status: {
    payroll: {
      draft: "کچا حساب",
  ...
  logs: {
    ...
    sunday: "اتوار",
    edited: "تبدیل شدہ",
    correctDay: "اس دن کو درست کریں",
    correctDayHint:
      "رہ گئے پنچ یا غلط مشین پر لگی چھٹی کے لیے۔ اس کے بعد دن بند ہو جاتا ہے تاکہ اگلا سنک اسے بدل نہ سکے۔",
    hoursFollow: "گھنٹے انہی دو اوقات سے نکالے جاتے ہیں۔",
    correctReason: "وجہ",
    correctReasonPlaceholder: "مشین نے چھٹی کا وقت نہیں لیا",
    correctReasonHint: "دن کے ساتھ محفوظ رہتی ہے، اور منظوری دینے والے کے پاس یہی بنیاد ہوتی ہے۔",
    approved: "منظور",
  ...
  rates: {
    ...
    employeesHint: "حاضری سے اجرت — ڈیوٹی گھنٹے، اوور ٹائم اور دیر کی کٹوتی لاگو",
    contractorsHint: "طے شدہ رقم، مقررہ۔ چھٹیوں کی کٹوتی نہیں، اوور ٹائم نہیں، دیر پر کٹوتی نہیں۔",
    noEmployees: "یہاں کسی کی اجرت حاضری سے نہیں۔",
    noContractors: "یہاں کوئی ٹھیکیدار نہیں۔",
